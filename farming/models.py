...
class Admin(models.Model):
    ...
    farm = models.ForeignKey("Farm",on_delete=models.CASCADE, default='', null=True, blank=True)
...
class Farmers(models.Model):
    ...
    admin = models.ForeignKey("Profile",on_delete=models.CASCADE, related_name = 'farm')
